...
import { View, Text, Animated, TouchableOpacity, TextInput, StatusBar, FlatList, Modal, Pressable, ActivityIndicator, Image } from "react-native";
...
export default function IncomingStationRequestScreen(props) {
    ...
    useEffect(() => {
        async function setScreen() {
            await backend.admin_station_requests(setItems, addMessage, setmessages, setShowIndicator)
        }
        setScreen()
        AnimateCurveRadius()
    }, [])
    ...
    return (
        <View style={styles.body} onLayout={async () => { await SplashScreen.hideAsync() }}>
                ...
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "center", alignItems: "center", marginTop: 20 }}>
                            ...
                            <TouchableOpacity
                                onPress={async () => {
                                    await backend.admin_change_station_status({ status: "in transit" }, currentItem._id, addMessage, setmessages, setShowModalIndicator)
            ...
            <Animated.View style={{ justifyContent: 'center', alignItems: "center", marginVertical: 5 }}>
                <Text style={styles.heading}>Withdraws</Text>
            </Animated.View>
                    ...
                    return (
                        <View style={styles.listStyle}>
                            ...
                            <TouchableOpacity style={styles.ViewBtn} onPress={() => {
                                ...
                                setCurrentItem(item)
                                setCurrentImg(item.documents[0])
                            }}>
