    ...
    return (
        <View style={styles.body} onLayout={async () => { await SplashScreen.hideAsync() }}>
            ...
            >
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        ...
                        <Pressable style={[styles.viewWholesalerBtn]}
                            onPress={() => {
                                navigation.navigate("ItemByWholesaler", {
            ...
            <View>
                ...
                <FlatList
                    data={CategoriesList}
                    contentContainerStyle={{ height: 80, paddingHorizontal: 10, marginTop: 20,}}
                    horizontal={true}
                    ...
                    renderItem={({ item, index }) => {
                        ...
                        return (
                            ...
                            <TouchableOpacity style={[styles.categoryStyle, { marginHorizontal: 9, backgroundColor: currentCategory == item.label ? color_scheme.primary : color_scheme.lightpurple }]} onPress={() => {
                                setCurrentCategory(item.label)


                            }}>

                                <Text style={{ fontFamily: "reg", color: currentCategory == item.label ? "#fff" : color_scheme.primary, fontSize: 14, }}>
                                    {item.label}
                                </Text>
