...
export default function RetailerSearchScreen({ route, navigation }) {
    ...
    useEffect(() => {
        async function setScreen() {
            await backend.Retailer_Search(setItems, { query: route.params.query }, addMessage, setmessages, setShowIndicator)
        }
        setScreen()
    }, [currentCategory])
    ...
    return (
        <View style={styles.body} onLayout={async () => { await SplashScreen.hideAsync() }}>
            ...
            <FlatList
                ...
                contentContainerStyle={{ width: "100%", alignItems: "center", marginTop: 10, flex: items.length == 0 ? 1 : null }}
