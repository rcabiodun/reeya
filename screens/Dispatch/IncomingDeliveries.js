...
export default function IncomingDeliveriesScreen(props) {
    ...
    useEffect(() => {
        async function setScreen() {
            await backend.dispatcher_pending_deliveries(setItems, addMessage, setmessages, setShowIndicator)
                ...
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
                            ...
                            <TouchableOpacity
                                onPress={async () => {
                                    await backend.dispatcher_change_order_status({ status: "in transit" }, currentItem._id, addMessage, setmessages, setShowModalIndicator)
                        ...
                        <Text style={{ fontFamily: "reg", fontSize: 11, color: color_scheme.primary, textAlign: "center", marginTop: 15 }}>
                            By accepting this item you also accept all other items made by the same retailer and wholesaler
                        </Text>
                        ...
                        <View style={styles.listStyle}>
                            <View style={{ flexDirection: "row", justifyContent: "space-between", }}>
                                ...
                                <TouchableOpacity style={styles.ViewBtn} onPress={() => {
                                    item.status == "accepted" ? setModalVisible(true) : null
                                    setCurrentItem(item)
                                }}>
                            ...
                            <Text style={[styles.orderCountTxt, { fontSize: 13, marginTop: 10 }]}>Pick-up Address: {item.wholesaler.address} </Text>
                            <Text style={[styles.orderCountTxt, { fontSize: 13, marginTop: 7 }]}>Delivery Address: {item.address} </Text>
